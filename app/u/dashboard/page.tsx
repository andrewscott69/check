...
const accountTypes = Object.values(BankAccountType);
...
export default function DashboardPage() {
  ...
  const selectedAccountData = userData.bankAccounts?.find(
            ...
            <CardContent className="pt-8 pb-8 px-8 text-center">
              <div className="mb-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Your account is currently awaiting approval. We're reviewing
                  your information and will notify you once the process is
                  complete.
                </p>
              </div>
          ...
          <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground">
                Welcome, {userData.firstName || userData.email.split("@")[0]}!
              </p>
            </div>
            <div className="flex items-center gap-2">
              <Button asChild>
                <Link href="/u/dashboard/send">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription>
                          {getAccountTypeLabel(selectedAccountData.accountType)}
                        </CardDescription>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="grid grid-cols-2 gap-1">
                            ...
                            <div className="text-right">
                              {selectedAccountData.currencyType}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          <div className="grid grid-cols-2 gap-1">
                            ...
                            <div className="text-right">
                              {selectedAccountData.interestRate}% APY
                            </div>
                          </div>
                          <div className="grid grid-cols-2 gap-1">
                            <div className="text-sm font-medium">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      $
                      {userData.totalSavings.toLocaleString("en-US", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </div>
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium  bg-green-100 text-green-800 px-2 py-1 rounded inline-block">
                      Monthly Spending
                    </CardTitle>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      $
                      {userData.monthlySpending.toLocaleString("en-US", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </div>
                  ...
                  <CardHeader>
                    ...
                    <CardDescription>
                      {userData.cards.length === 0
                        ? "No cards added yet"
                        : `You have ${userData.cards.length} active card${
                            userData.cards.length > 1 ? "s" : ""
                          }`}
                    </CardDescription>
                  </CardHeader>
