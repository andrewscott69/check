...
import { ArrowRight, DollarSign, Eye, EyeOff, Loader2 } from "lucide-react";
  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    try {
      ...
      if (result.status === "login") {
        ...
        toast.success("OTP sent to Authentication Device.");
        return;
      }
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-amber-500" disabled={isLoading}>
              {isLoading ? (
                <>
